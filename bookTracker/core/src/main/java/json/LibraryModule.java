 ...
 * The module provides serializers and deserializers for the classes Book and BookShelf.
 */
@SuppressWarnings("serial")
public class LibraryModule extends SimpleModule {
  
  private static final String NAME = "LibraryModule";
    
    /**
     * Constructor that adds serializers and deserializers.
     */
